    	...
    	if (config.getUserName() != null && config.getPassword() !=null) {
            client.register(new ClientRequestFilter() {
                ...
                public void filter(ClientRequestContext requestContext) throws IOException {
            		...
            		String authenticationToken = "Basic " + java.util.Base64.getEncoder().encodeToString( usernameAndPassword.getBytes() );

                    requestContext.getHeaders().add("Authorization", authenticationToken);
                }
            });
        }
